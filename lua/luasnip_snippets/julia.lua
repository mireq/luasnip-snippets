...
ls.add_snippets("julia", {
	...
	s({trig = "docf", descr = "(docf) \"function documentation\"", priority = 0, trigEngine = te("b")}, {
		...
		t"#\'", nl(),
		t"#\' ", c(2, {{t"@param ", i(1, "name", {key = "i3"}), t"::", i(2, "Type", {key = "i4"}), t" ", i(3, "Description", {key = "i5"})}, {i(1, jt({"@param ", "name", "::", "Type", " ", "Description"}))}}, {key = "i2"}), nl(),
		t"#\'", nl(),
		t"#\' ", c(3, {{t"@returns ", i(1, "name", {key = "i7"}), t"::", i(2, "Type", {key = "i8"}), t" ", i(3, "Description", {key = "i9"})}, {i(1, jt({"@returns ", "name", "::", "Type", " ", "Description"}))}}, {key = "i6"}), nl(),
		t"#\'", nl(),
		t"#\' @examples", nl(),
		t"#\'", nl(),
	...
	s({trig = "doct", descr = "(doct) \"type definition\"", priority = 0, trigEngine = te("b")}, {
		...
		t"#\'", nl(),
		t"#\' ", c(2, {{t"@field ", i(1, "name", {key = "i3"}), t"::", i(2, "Type", {key = "i4"}), t" ", i(3, "Description", {key = "i5"})}, {i(1, jt({"@field ", "name", "::", "Type", " ", "Description"}))}}, {key = "i2"}), nl(),
		t"#\'", nl(),
		t"#\' @examples", nl(),
		t"#\'", nl(),
