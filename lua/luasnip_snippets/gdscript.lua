...
ls.add_snippets("gdscript", {
	...
	s({trig = "signal", descr = "(signal)", priority = -1000, trigEngine = te("w")}, {
		t"signal ", i(1, "signalname", {key = "i1"}), t"(", i(2, "args", {key = "i2"}), t")", nl(),
		nl()
	}),
	s({trig = "export", descr = "(export)", priority = -1000, trigEngine = te("w")}, {
		t"export(", i(1, "type", {key = "i1"}), i(2, ",other_configs", {key = "i2"}), t") var ", i(3, "name", {key = "i3"}), i(4, " = default", {key = "i4"}), i(5, " setget ", {key = "i5"}), nl(),
		nl()
	}),
	s({trig = "var", descr = "(var)", priority = -1000, trigEngine = te("w")}, {
		t"var ", i(1, "name", {key = "i1"}), i(2, " = default", {key = "i2"}), i(3, " setget ", {key = "i3"}), nl(),
		nl()
	}),
	s({trig = "onready", descr = "(onready)", priority = -1000, trigEngine = te("w")}, {
		t"onready var ", i(1, "name", {key = "i1"}), t" = get_node(", i(2, "", {key = "i2"}), t")", nl(),
		nl()
	}),
	s({trig = "is", descr = "(is)", priority = -1000, trigEngine = te("w")}, {
		i(1, "instance", {key = "i1"}), t" is ", i(2, "class", {key = "i2"}), nl(),
		nl()
	}),
	s({trig = "in", descr = "(in)", priority = -1000, trigEngine = te("w")}, {
		i(1, "element", {key = "i1"}), t" in ${", i(2, "", {key = "i2"}), t":array}", nl(),
		nl()
	}),
