...
ls.add_snippets("d", {
	...
	s({trig = "get", descr = "(get) \"getter property (get)\"", priority = -50, trigEngine = te("")}, {
		t"@property ", i(1, "/*type*/", {key = "i1"}), t" ", i(2, "/*member_name*/", {key = "i2"}), t"() const pure nothrow {return ", cp(2), t"_", t";}"
	}),
	s({trig = "set", descr = "(set) \"setter property (set)\"", priority = -50, trigEngine = te("")}, {
		t"@property void ", i(1, "/*member_name*/", {key = "i1"}), t"(", i(2, "/*type*/", {key = "i2"}), t" rhs) pure nothrow {", cp(1), t"_", t" = rhs;}"
	}),
	...
	s({trig = "struct", descr = "(struct) \"struct (struct)\"", priority = -50, trigEngine = te("")}, {
		t"struct ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"d", 54}, "snip.rv = (snip.basename or \"name\")", python_globals, args, snip, "", am[54])}, ""), {key = "i1"}) }) end), nl(),
		t"{", nl(),
		t"\t", i(2, "", {key = "i2"}), nl(),
		t"}"
	}),
	s({trig = "union", descr = "(union) \"union (union)\"", priority = -50, trigEngine = te("")}, {
		t"union ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"d", 55}, "snip.rv = (snip.basename or \"name\")", python_globals, args, snip, "", am[55])}, ""), {key = "i1"}) }) end), nl(),
		t"{", nl(),
		t"\t", i(2, "", {key = "i2"}), nl(),
		t"}"
	}),
	s({trig = "class", descr = "(class) \"class (class)\"", priority = -50, trigEngine = te("")}, {
		t"class ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"d", 56}, "snip.rv = (snip.basename or \"name\")", python_globals, args, snip, "", am[56])}, ""), {key = "i1"}) }) end), nl(),
		t"{", nl(),
		t"\t", i(2, "", {key = "i2"}), nl(),
		t"}"
	}),
	s({trig = "inter", descr = "(inter) \"interface (inter)\"", priority = -50, trigEngine = te("")}, {
		t"interface ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"d", 57}, "snip.rv = (snip.basename or \"name\")", python_globals, args, snip, "", am[57])}, ""), {key = "i1"}) }) end), nl(),
		t"{", nl(),
		t"\t", i(2, "", {key = "i2"}), nl(),
		t"}"
	}),
	s({trig = "enum", descr = "(enum) \"enum (enum)\"", priority = -50, trigEngine = te("")}, {
		t"enum ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"d", 58}, "snip.rv = (snip.basename or \"name\")", python_globals, args, snip, "", am[58])}, ""), {key = "i1"}) }) end), nl(),
		t"{", nl(),
		t"\t", i(2, "", {key = "i2"}), nl(),
		t"}"
	}),
	...
	s({trig = "fdoc", descr = "(fdoc) \"function ddoc block (fdoc)\"", priority = -50, trigEngine = te("b")}, {
		t"/// ", i(1, "description", {key = "i1"}), nl(),
		t"///", nl(),
		t"/// ", t"Params:  ", i(2, "param", {key = "i2"}), t" = ", i(3, "param description", {key = "i3"}), nl(),
t"///", i(4, "", {key = "i5"}), t"\t $", nl(),
		t"///", nl(),
		t"/// ", t"Returns: ", i(5, "return value", {key = "i5"}), nl(),
		t"///", nl(),
		t"/// ", t"Throws:  ", i(6, "", {key = "i9"}), t"Exception ", i(7, "", {key = "i10"})
	}),
	...
	s({trig = "tcf", descr = "(tcf)", priority = -1000, trigEngine = te("w")}, {
		t"try {", nl(),
		t"\t", d(5, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, "\t"), {key = "i5"}) }) end), nl(),
