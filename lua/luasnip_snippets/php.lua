...
ls.add_snippets("php", {
	s({trig = "gm", descr = "(gm) \"PHP Class Getter\"", priority = -50, trigEngine = te("b")}, {
		...
		t" */", nl(),
		t"public function get", tr(1, "\\w+\\s*", "\\u$0"), t"()", f(function(args, snip) return c_py({"php", 1}, "snip.rv = \': \'+t[2] if isPHPScalarTypesEnabled() else \'\'", python_globals, args, snip, "", am[1]) end, ae(am[1])), nl(),
		t"{", nl(),
	...
	s({trig = "gs", descr = "(gs) \"PHP Class Getter Setter\"", priority = -50, trigEngine = te("b")}, {
		...
		t" * @return ", i(2, "string", {key = "i2"}), nl(),
		t" */", nl(),
		t"public function get", tr(1, "\\w+\\s*", "\\u$0"), t"()", f(function(args, snip) return c_py({"php", 3}, "snip.rv = \': \'+t[2] if isPHPScalarTypesEnabled() else \'\'", python_globals, args, snip, "", am[3]) end, ae(am[3])), nl(),
		t"{", nl(),
		t"    return $this->", cp(1), t";", nl(),
		t"}", nl(),
		nl(),
	...
	s({trig = "ns", descr = "(ns) \"namespace declaration\"", priority = -50, trigEngine = te("b")}, {
		t"namespace ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"php", 12}, "\nrelpath = os.path.relpath(path)\nm = re.search(r\'[A-Z].+(?=/)\', relpath)\nif m:\n\tsnip.rv = m.group().replace(\'/\', \'\\\\\')\n", python_globals, args, snip, "", am[12])}, ""), {key = "i1"}) }) end), t";"
	}),
	...
	s({trig = "interface", descr = "(interface) \"Interface declaration template\"", priority = -50, trigEngine = te("b")}, {
		t"<?php", nl(),
		nl(),
		t"namespace ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"php", 14}, "\nrelpath = os.path.relpath(path)\nm = re.search(r\'[A-Z].+(?=/)\', relpath)\nif m:\n\tsnip.rv = m.group().replace(\'/\', \'\\\\\')\n", python_globals, args, snip, "", am[14])}, ""), {key = "i1"}) }) end), t";", nl(),
		nl(),
		t"/**", nl(),
		t" * Interface ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"php", 14}, "snip.rv=snip.basename", python_globals, args, snip, "", am[14])}, " "), {key = "i1"}) }) end), nl(),
	...
	s({trig = "trait", descr = "(trait) \"Trait declaration template\"", priority = -50, trigEngine = te("b")}, {
		t"<?php", nl(),
		nl(),
		t"namespace ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"php", 15}, "\nrelpath = os.path.relpath(path)\nm = re.search(r\'[A-Z].+(?=/)\', relpath)\nif m:\n\tsnip.rv = m.group().replace(\'/\', \'\\\\\')\n", python_globals, args, snip, "", am[15])}, ""), {key = "i1"}) }) end), t";", nl(),
		nl(),
		t"/**", nl(),
		t" * Trait ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"php", 15}, "snip.rv=snip.basename", python_globals, args, snip, "", am[15])}, " "), {key = "i1"}) }) end), nl(),
		t" * @author ", d(2, function(args, snip) return sn(nil, { i(1, jt({c_viml("g:snips_author")}, " "), {key = "i2"}) }) end), nl(),
		t" */", nl(),
		t"trait ", cp(1), nl(),
		t"{", nl(),
	...
	s({trig = "testcase", descr = "(testcase) \"class XYZTest extends \\PHPUnit_Framework_TestCase { ... }\"", priority = -50, trigEngine = te("")}, {
		t"<?php", nl(),
		nl(),
		t"namespace ", f(function(args, snip) return c_py({"php", 17}, "\nrelpath = os.path.relpath(path)\nm = re.search(r\'[A-Z].+(?=/)\', relpath)\nif m:\n\tsnip.rv = m.group().replace(\'/\', \'\\\\\')\n", python_globals, args, snip, "", am[17]) end, ae(am[17])), t";", nl(),
		nl(),
		t"/**", nl(),
		t" * @author ", f(function(args, snip) return c_viml("g:snips_author") end, {}), nl(),
		t" */", nl(),
		t"class ", f(function(args, snip) return c_py({"php", 17}, "\nsnip.rv = re.match(r\'.*(?=\\.)\', fn).group()\n", python_globals, args, snip, "", am[17]) end, ae(am[17])), t" extends \\PHPUnit_Framework_TestCase", nl(),
		t"{", nl(),
	...
	s({trig = "testcase6", descr = "(testcase6) \"class XYZTest extends TestCase { ... }\"", priority = -50, trigEngine = te("")}, {
		t"<?php", nl(),
		nl(),
		t"namespace ", f(function(args, snip) return c_py({"php", 18}, "\nrelpath = os.path.relpath(path)\nm = re.search(r\'[A-Z].+(?=/)\', relpath)\nif m:\n\tsnip.rv = m.group().replace(\'/\', \'\\\\\')\n", python_globals, args, snip, "", am[18]) end, ae(am[18])), t";", nl(),
		nl(),
		...
		t" * @author ", f(function(args, snip) return c_viml("g:snips_author") end, {}), nl(),
		t" */", nl(),
		t"class ", f(function(args, snip) return c_py({"php", 18}, "\nsnip.rv = re.match(r\'.*(?=\\.)\', fn).group()\n", python_globals, args, snip, "", am[18]) end, ae(am[18])), t" extends TestCase", nl(),
		t"{", nl(),
		t"\tpublic function test", i(1, "", {key = "i1"}), t"()", nl(),
		t"\t{", nl(),
		t"\t\t", d(2, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, "\t\t"), {key = "i2"}) }) end), nl(),
	...
	s({trig = "wp_options_page", descr = "(wp_options_page)", priority = 0, trigEngine = te("")}, {
		...
		t"\t\t\t\'", i(4, "option_name", {key = "i4"}), t"\',", nl(),
		t"\t\t\t\'", i(5, "Option", {key = "i5"}), t"\',", nl(),
	...
	s({trig = "doc_c", descr = "(doc_c)", priority = -1000, trigEngine = te("w")}, {
		...
		t"{", nl(),
		t"\t", d(7, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, "\t"), {key = "i7"}) }) end), nl(),
	...
	s({trig = "doc_h", descr = "(doc_h)", priority = -1000, trigEngine = te("w")}, {
		...
		t" * @copyright ", cp(2), t", ", f(function(args, snip) return c_viml("strftime(\'%d %B, %Y\')") end, {}), nl(),
	...
	s({trig = "ags", descr = "(ags)", priority = -1000, trigEngine = te("w")}, {
		...
		nl(),
		t"public function get", cp(3), t"()", nl(),
		t"{", nl(),
		t"\treturn $this->", cp(3), t";", nl(),
		t"}", nl(),
		nl(),
		t"public function set", cp(4), t"(", cp(4), t" ", t"$", cp(3), t")", nl(),
		t"{", nl(),
