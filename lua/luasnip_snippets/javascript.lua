...
ls.add_snippets("javascript", {
	...
	s({trig = "rfc", descr = "(rfc) \"react functional component\"", priority = 0, trigEngine = te("b")}, {
		...
		nl(),
		t"function ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"javascript", 2}, "snip.rv = snip.basename", python_globals, args, snip, "", am[2])}, ""), {key = "i1"}) }) end), t"(", i(2, "", {key = "i2"}), t"){", nl(),
		t"\treturn(", nl(),
		t"\t\t<div>", nl(),
		...
		t"}", nl(),
		nl(),
		t"export default ", i(4, "", {key = "i4"}), f(function(args, snip) return c_py({"javascript", 2}, "snip.rv = snip.basename", python_globals, args, snip, "", am[2]) end, ae(am[2]))
	}),
	s({trig = "useS", descr = "(useS) \"useState Hook\"", priority = 0, trigEngine = te("b")}, {
		t"const [", i(1, "", {key = "i1"}), t", set", f(function(args, snip) return c_py({"javascript", 3}, "snip.rv=capitalize_first(t[1])", python_globals, args, snip, "", am[3]) end, ae(am[3])), t"] = useState(", t"\"", i(2, "", {key = "i4"}), t"\"", t")"
	}),
...
i(2, "", {key = "i3"}), t"\t${3}", nl(), t", [", i(3, "", {key = "i4"}), t"])"
	...
	s({trig = "\'\':f", descr = "(\'\':f) \"object method string\"", priority = -50, trigEngine = te("")}, {
		t"\'", i(1, "#thing", {key = "i1"}), t":", i(2, "click", {key = "i2"}), t"\': function", f(function(args, snip) return c_py({"javascript", 13}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[13]) end, ae(am[13])), t"(element) {", nl(),
	...
	s({trig = ":f", descr = "(:f) \"Object Method\"", priority = -50, trigEngine = te("")}, {
		i(1, "method_name", {key = "i1"}), t": function", f(function(args, snip) return c_py({"javascript", 14}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[14]) end, ae(am[14])), t"(", i(2, "attribute", {key = "i2"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}", i(3, ",", {key = "i3"})
	}),
	...
	s({trig = ":", descr = "(:) \"Object key key: \'value\'\"", priority = -50, trigEngine = te("")}, {
		i(1, "key", {key = "i1"}), t": ", t"\"", i(2, "value", {key = "i2"}), t"\"", i(3, ", ", {key = "i3"})
	}),
	s({trig = "proto", descr = "(proto) \"Prototype (proto)\"", priority = -50, trigEngine = te("")}, {
		i(1, "class_name", {key = "i1"}), t".prototype.", i(2, "method_name", {key = "i2"}), t" = function", f(function(args, snip) return c_py({"javascript", 17}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[17]) end, ae(am[17])), t"(", i(3, "first_argument", {key = "i3"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}", f(function(args, snip) return c_py({"javascript", 17}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[17]) end, ae(am[17])), nl()
	}),
	s({trig = "fun", descr = "(fun) \"function (named)\"", priority = -50, trigEngine = te("b")}, {
		t"function ", i(1, "function_name", {key = "i1"}), f(function(args, snip) return c_py({"javascript", 18}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[18]) end, ae(am[18])), t"(", i(2, "argument", {key = "i2"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "vf", descr = "(vf) \"function (assigned to var)\"", priority = -50, trigEngine = te("")}, {
		i(1, "var ", {key = "i1"}), i(2, "function_name", {key = "i2"}), t" = function ", cp(2), f(function(args, snip) return c_py({"javascript", 19}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[19]) end, ae(am[19])), t"(", i(3, "", {key = "i3"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}", f(function(args, snip) return c_py({"javascript", 19}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[19]) end, ae(am[19]))
	}),
	s({trig = "anf", descr = "(anf) \"function (anonymous)\"", priority = -50, trigEngine = te("i")}, {
		t"function", f(function(args, snip) return c_py({"javascript", 20}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[20]) end, ae(am[20])), t"(", i(1, "", {key = "i1"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "iife", descr = "(iife) \"Immediately-Invoked Function Expression (iife)\"", priority = -50, trigEngine = te("")}, {
		t"(function", f(function(args, snip) return c_py({"javascript", 21}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[21]) end, ae(am[21])), t"(", i(1, "window", {key = "i1"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}(", cp(1), t"))", f(function(args, snip) return c_py({"javascript", 21}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[21]) end, ae(am[21]))
	}),
	s({trig = ";fe", descr = "(;fe) \"Minify safe iife\"", priority = -50, trigEngine = te("")}, {
		t";(function", f(function(args, snip) return c_py({"javascript", 22}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[22]) end, ae(am[22])), t"(", i(1, "", {key = "i1"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}(", i(2, "", {key = "i2"}), t"))"
	}),
	s({trig = "timeout", descr = "(timeout) \"setTimeout function\"", priority = -50, trigEngine = te("")}, {
		t"setTimeout(function", f(function(args, snip) return c_py({"javascript", 23}, "snip.rv = space_before_function_paren(snip)", python_globals, args, snip, "", am[23]) end, ae(am[23])), t"() {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}", t".bind(", i(2, "this", {key = "i2"}), t")", t", ", i(1, "10", {key = "i1"}), t")", f(function(args, snip) return c_py({"javascript", 23}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[23]) end, ae(am[23]))
	}),
	s({trig = "fi", descr = "(fi) \"for prop in obj using hasOwnProperty\"", priority = -50, trigEngine = te("b")}, {
		t"for", f(function(args, snip) return c_py({"javascript", 24}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[24]) end, ae(am[24])), t"(", i(1, "prop", {key = "i1"}), t" in ", i(2, "obj", {key = "i2"}), t"){", nl(),
		t"\tif", f(function(args, snip) return c_py({"javascript", 24}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[24]) end, ae(am[24])), t"(", cp(2), t".hasOwnProperty(", cp(1), t")) {", nl(),
		t"\t\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"\t}", nl(),
		t"}"
	}),
	s({trig = "if", descr = "(if) \"if (condition) { ... }\"", priority = -50, trigEngine = te("")}, {
		t"if", f(function(args, snip) return c_py({"javascript", 25}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[25]) end, ae(am[25])), t"(", i(1, "true", {key = "i1"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "ife", descr = "(ife) \"if (condition) { ... } else { ... }\"", priority = -50, trigEngine = te("")}, {
		t"if", f(function(args, snip) return c_py({"javascript", 26}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[26]) end, ae(am[26])), t"(", i(1, "true", {key = "i1"}), t") {", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}", f(function(args, snip) return c_py({"javascript", 26}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[26]) end, ae(am[26])), t"else", f(function(args, snip) return c_py({"javascript", 26}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[26]) end, ae(am[26])), t"{", nl(),
		t"\t", i(2, "", {key = "i2"}), nl(),
		t"}"
	}),
	s({trig = "switch", descr = "(switch)", priority = -50, trigEngine = te("")}, {
		t"switch", f(function(args, snip) return c_py({"javascript", 27}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[27]) end, ae(am[27])), t"(", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(1, "expression", {key = "i1"}), t") {", nl(),
		t"\tcase \'", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(3, "case", {key = "i3"}), t"\':", nl(),
		t"\t\t", i(4, "", {key = "i4"}), nl(),
		t"\t\tbreak", f(function(args, snip) return c_py({"javascript", 27}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[27]) end, ae(am[27])), nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"\tdefault:", nl(),
		t"\t\t", i(2, "", {key = "i2"}), nl(),
		t"}"
	...
	s({trig = "case", descr = "(case) \"case \'xyz\': ... break\"", priority = -50, trigEngine = te("")}, {
		t"case", f(function(args, snip) return c_py({"javascript", 28}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[28]) end, ae(am[28])), t"\'", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(1, "case", {key = "i1"}), t"\':", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"\tbreak", f(function(args, snip) return c_py({"javascript", 28}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[28]) end, ae(am[28]))
	}),
	s({trig = "do", descr = "(do) \"do { ... } while (condition)\"", priority = -50, trigEngine = te("")}, {
		t"do", f(function(args, snip) return c_py({"javascript", 29}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[29]) end, ae(am[29])), t"{", nl(),
		t"\t", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), nl(),
		t"}", f(function(args, snip) return c_py({"javascript", 29}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[29]) end, ae(am[29])), t"while", f(function(args, snip) return c_py({"javascript", 29}, "snip.rv = keyword_spacing(snip)", python_globals, args, snip, "", am[29]) end, ae(am[29])), t"(", i(1, "/* condition */", {key = "i1"}), t")", f(function(args, snip) return c_py({"javascript", 29}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[29]) end, ae(am[29]))
	}),
	s({trig = "ret", descr = "(ret) \"Return statement\"", priority = -50, trigEngine = te("")}, {
		t"return ", f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), i(0, "", {key = "i0"}), f(function(args, snip) return c_py({"javascript", 30}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[30]) end, ae(am[30]))
	}),
	s({trig = "us", descr = "(us)", priority = -50, trigEngine = te("")}, {
		t"\'use strict\'", f(function(args, snip) return c_py({"javascript", 31}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[31]) end, ae(am[31]))
	}),
	...
	s({trig = "de", descr = "(de)", priority = -50, trigEngine = te("")}, {
		t"debugger", f(function(args, snip) return c_py({"javascript", 33}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[33]) end, ae(am[33]))
	}),
	s({trig = "cl", descr = "(cl) \"console.log\"", priority = -50, trigEngine = te("")}, {
		t"console.log(", i(0, "", {key = "i0"}), t")", f(function(args, snip) return c_py({"javascript", 34}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[34]) end, ae(am[34]))
	}),
	s({trig = "cd", descr = "(cd) \"console.debug\"", priority = -50, trigEngine = te("")}, {
		t"console.debug(", i(0, "", {key = "i0"}), t")", f(function(args, snip) return c_py({"javascript", 35}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[35]) end, ae(am[35]))
	}),
	s({trig = "ce", descr = "(ce) \"console.error\"", priority = -50, trigEngine = te("")}, {
		t"console.error(", i(0, "", {key = "i0"}), t")", f(function(args, snip) return c_py({"javascript", 36}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[36]) end, ae(am[36]))
	}),
	s({trig = "cw", descr = "(cw) \"console.warn\"", priority = -50, trigEngine = te("")}, {
		t"console.warn(", i(0, "", {key = "i0"}), t")", f(function(args, snip) return c_py({"javascript", 37}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[37]) end, ae(am[37]))
	}),
	s({trig = "ci", descr = "(ci) \"console.info\"", priority = -50, trigEngine = te("")}, {
		t"console.info(", i(0, "", {key = "i0"}), t")", f(function(args, snip) return c_py({"javascript", 38}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[38]) end, ae(am[38]))
	}),
	s({trig = "ct", descr = "(ct) \"console.trace\"", priority = -50, trigEngine = te("")}, {
		t"console.trace(", i(0, "label", {key = "i0"}), t")", f(function(args, snip) return c_py({"javascript", 39}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[39]) end, ae(am[39]))
	}),
	s({trig = "ctime", descr = "(ctime) \"console.time ... console.timeEnd\"", priority = -50, trigEngine = te("")}, {
		t"console.time(\"", i(1, "label", {key = "i1"}), t"\")", f(function(args, snip) return c_py({"javascript", 40}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[40]) end, ae(am[40])), nl(),
		d(2, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, ""), {key = "i2"}) }) end), nl(),
		t"console.timeEnd(\"", cp(1), t"\")", f(function(args, snip) return c_py({"javascript", 40}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[40]) end, ae(am[40]))
	}),
	s({trig = "ctimestamp", descr = "(ctimestamp) \"console.timeStamp\"", priority = -50, trigEngine = te("")}, {
		t"console.timeStamp(\"", i(1, "label", {key = "i1"}), t"\")", f(function(args, snip) return c_py({"javascript", 41}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[41]) end, ae(am[41]))
	}),
	s({trig = "ca", descr = "(ca) \"console.assert\"", priority = -50, trigEngine = te("")}, {
		t"console.assert(", i(1, "expression", {key = "i1"}), t", ", i(0, "obj", {key = "i0"}), t")", f(function(args, snip) return c_py({"javascript", 42}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[42]) end, ae(am[42]))
	}),
	s({trig = "cclear", descr = "(cclear) \"console.clear\"", priority = -50, trigEngine = te("")}, {
		t"console.clear()", f(function(args, snip) return c_py({"javascript", 43}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[43]) end, ae(am[43]))
	}),
	s({trig = "cdir", descr = "(cdir) \"console.dir\"", priority = -50, trigEngine = te("")}, {
		t"console.dir(", i(0, "obj", {key = "i0"}), t")", f(function(args, snip) return c_py({"javascript", 44}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[44]) end, ae(am[44]))
	}),
	s({trig = "cdirx", descr = "(cdirx) \"console.dirxml\"", priority = -50, trigEngine = te("")}, {
		t"console.dirxml(", i(1, "object", {key = "i1"}), t")", f(function(args, snip) return c_py({"javascript", 45}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[45]) end, ae(am[45]))
	}),
	s({trig = "cgroup", descr = "(cgroup) \"console.group\"", priority = -50, trigEngine = te("")}, {
		t"console.group(\"", i(1, "label", {key = "i1"}), t"\")", f(function(args, snip) return c_py({"javascript", 46}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[46]) end, ae(am[46])), nl(),
		d(2, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, ""), {key = "i2"}) }) end), nl(),
		t"console.groupEnd()", f(function(args, snip) return c_py({"javascript", 46}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[46]) end, ae(am[46]))
	}),
	s({trig = "cgroupc", descr = "(cgroupc) \"console.groupCollapsed\"", priority = -50, trigEngine = te("")}, {
		t"console.groupCollapsed(\"", i(1, "label", {key = "i1"}), t"\")", f(function(args, snip) return c_py({"javascript", 47}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[47]) end, ae(am[47])), nl(),
		d(2, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, ""), {key = "i2"}) }) end), nl(),
		t"console.groupEnd()", f(function(args, snip) return c_py({"javascript", 47}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[47]) end, ae(am[47]))
	}),
	s({trig = "cprof", descr = "(cprof) \"console.profile\"", priority = -50, trigEngine = te("")}, {
		t"console.profile(\"", i(1, "label", {key = "i1"}), t"\")", f(function(args, snip) return c_py({"javascript", 48}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[48]) end, ae(am[48])), nl(),
		d(2, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, ""), {key = "i2"}) }) end), nl(),
		t"console.profileEnd()", f(function(args, snip) return c_py({"javascript", 48}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[48]) end, ae(am[48]))
	}),
	s({trig = "ctable", descr = "(ctable) \"console.table\"", priority = -50, trigEngine = te("")}, {
		t"console.table(", t"\"", i(1, "value", {key = "i1"}), t"\"", t")", f(function(args, snip) return c_py({"javascript", 49}, "snip.rv = semi(snip)", python_globals, args, snip, "", am[49]) end, ae(am[49]))
	}),
	...
	s({trig = "prop", descr = "(prop)", priority = -1000, trigEngine = te("w")}, c(1, {
		{
			...
			t"\t\tconfigurable : ", i(6, "boolean", {key = "i6"}), nl(),
			t"\t}", nl(),
			t");"
		},
		{
	...
	s({trig = "af", descr = "(af) \"() =>\"", priority = -1000, trigEngine = te("w")}, {
		t"(", i(1, "", {key = "i1"}), t") => ", d(2, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, ""), {key = "i2"}) }) end)
	}),
	...
	s({trig = "aw", descr = "(aw) \"await\"", priority = -1000, trigEngine = te("w")}, {
		t"await ", d(1, function(args, snip) return sn(nil, { i(1, jt({snip.env.LS_SELECT_DEDENT or {}}, ""), {key = "i1"}) }) end)
	}),
