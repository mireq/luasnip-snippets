...
ls.add_snippets("php-laravel", {
	...
	s({trig = "l_rsp", descr = "(l_rsp) \"Laravel service provider for repository\"", priority = 0, trigEngine = te("b")}, {
		...
		t" */", nl(),
		nl(),
		t"namespace ", t"Repositories\\", i(1, "", {key = "i1"}), t";", nl(),
		nl(),
		...
		t"     */", nl(),
		t"    protected $defer = ", i(4, "true", {key = "i4"}), t";", nl(),
		nl(),
		t"    public function register() {", nl(),
	...
	s({trig = "l_r", descr = "(l_r) \"Laravel Repository\"", priority = 0, trigEngine = te("b")}, {
		...
		t" *", nl(),
		t" * \\author      ", d(3, function(args, snip) return sn(nil, { i(1, jt({c_viml("g:snips_author")}, " "), {key = "i5"}) }) end), nl(),
		t" * \\date        ", f(function(args, snip) return c_viml("strftime(\'%d-%m-%y\')") end, {}), nl(),
		t" */", nl(),
		nl(),
		t"namespace ", t"Repositories\\", i(1, "", {key = "i2"}), t";", nl(),
		nl(),
		t"class ", d(2, function(args, snip) return sn(nil, { i(1, jt({c_viml("expand(\'%:t:r\')")}, ""), {key = "i3"}) }) end), t" extends \\", i(4, "", {key = "i6"}), t" implements ", cp(3), t"RepositoryInterface", t" {", nl(),
		t"    ", i(5, "", {key = "i7"}), nl(),
		t"}"
	}),
	...
	s({trig = "l_f", descr = "(l_f) \"Laravel Facade\"", priority = 0, trigEngine = te("b")}, {
		...
		t"     * \\return      string", nl(),
		t"     */", nl(),
		t"    protected static function getFacadeAccessor() { return \'", i(3, "", {key = "i3"}), t"Service", t"\'; }", nl(),
		t"}"
	}),
})
