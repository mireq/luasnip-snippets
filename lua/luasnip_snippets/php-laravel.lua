...
ls.add_snippets("php-laravel", {
	...
	s({trig = "l_rsp", descr = "(l_rsp) \"Laravel service provider for repository\"", priority = 0, trigEngine = te("b")}, {
		...
		t" */", nl(),
		nl(),
		t"namespace ", d(2, function(args) return sn(nil, {t"Repositories\\", i(1, "", {key = "i1"})}) end, {}, {key = "i2"}), t";", nl(),
		nl(),
		t"use Entities\\", cp(1), t";", nl(),
		t"use ", cp(2), t"\\", cp(1), t"Repository;", nl(),
		t"use Illuminate\\Support\\ServiceProvider;", nl(),
		nl(),
		t"class ", d(3, function(args, snip) return sn(nil, { i(1, jt({c_viml("expand(\'%:t:r\')")}, ""), {key = "i3"}) }) end), t" extends ServiceProvider {", nl(),
		t"    /*!", nl(),
		t"     * \\var     defer", nl(),
	...
	s({trig = "l_r", descr = "(l_r) \"Laravel Repository\"", priority = 0, trigEngine = te("b")}, {
		...
		t" */", nl(),
		nl(),
		t"namespace ", d(1, function(args) return sn(nil, {t"Repositories\\", i(2, "", {key = "i2"})}) end, {}, {key = "i1"}), t";", nl(),
		nl(),
		t"class ", d(3, function(args, snip) return sn(nil, { i(1, jt({c_viml("expand(\'%:t:r\')")}, ""), {key = "i3"}) }) end), t" extends \\", i(6, "", {key = "i6"}), t" implements ", d(4, function(args) return sn(nil, {cp(3), t"RepositoryInterface"}) end, {}, {key = "i4"}), t" {", nl(),
		t"    ", i(7, "", {key = "i7"}), nl(),
		t"}"
	}),
	s({trig = "l_s", descr = "(l_s) \"Laravel Service\"", priority = 0, trigEngine = te("b")}, {
		...
		nl(),
		t"use ", d(3, function(args) return sn(nil, {t"Repositories\\", i(4, "Interface", {key = "i4"})}) end, {}, {key = "i3"}), t";", nl(),
		nl(),
	...
	s({trig = "l_f", descr = "(l_f) \"Laravel Facade\"", priority = 0, trigEngine = te("b")}, {
		...
		t"     * \\return      string", nl(),
		t"     */", nl(),
		t"    protected static function getFacadeAccessor() { return \'", d(4, function(args) return sn(nil, {i(3, "", {key = "i3"}), t"Service"}) end, {}, {key = "i4"}), t"\'; }", nl(),
		t"}"
	}),
})
