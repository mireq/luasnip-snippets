...
ls.add_snippets("cs", {
	...
	s({trig = "interface", descr = "(interface) \"interface\"", priority = -50, trigEngine = te("w")}, {
		t"interface I", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"cs", 16}, "snip.rv = snip.basename", python_globals, args, snip, "", {})}, ""), {key = "i1"}) }) end), nl(),
		t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "class", descr = "(class) \"class\"", priority = -50, trigEngine = te("w")}, {
		i(1, "public", {key = "i1"}), t" class ", d(2, function(args, snip) return sn(nil, { i(1, jt({c_py({"cs", 18}, "snip.rv = snip.basename", python_globals, args, snip, "", {})}, " "), {key = "i2"}) }) end), nl(),
		t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "ctor", descr = "(ctor) \"Constructor\"", priority = -50, trigEngine = te("b")}, {
		i(1, "public", {key = "i1"}), t" ", d(2, function(args, snip) return sn(nil, { i(1, jt({c_py({"cs", 26}, "snip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", {})}, " "), {key = "i2"}) }) end), t"(", i(3, "", {key = "i3"}), t")", nl(),
		t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "struct", descr = "(struct) \"struct\"", priority = -50, trigEngine = te("w")}, {
		t"struct ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"cs", 92}, "snip.rv = snip.basename", python_globals, args, snip, "", {})}, ""), {key = "i1"}) }) end), nl(),
		t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
