...
ls.add_snippets("smarty", {
	...
	s({trig = "append", descr = "(append) \"{append} is used for creating or appending template variable arrays during the execution of a template.\"", priority = 0, trigEngine = te("")}, {
		t"{append var=\'", i(1, "", {key = "i1"}), t"\' value=\'", i(2, "", {key = "i2"}), t"\'", d(3, function(args) return sn(nil, {t" index=\'", c(1, {i(1, "first"), i(1, "last")}, {key = "i4"}), t"\'"}) end, {}, {key = "i3"}), d(4, function(args) return sn(nil, {t" scope=\'", c(1, {i(1, "parent"), i(1, "root"), i(1, "global")}, {key = "i6"}), t"\'"}) end, {}, {key = "i5"}), t"}"
	}),
	s({trig = "assign", descr = "(assign) \"{assign} is used for assigning template variables during the execution of a template.\"", priority = 0, trigEngine = te("")}, {
		t"{assign var=\'", i(1, "", {key = "i1"}), t"\' value=\'", i(2, "", {key = "i2"}), t"\'", d(3, function(args) return sn(nil, {t" scope=\'", c(1, {i(1, "parent"), i(1, "root"), i(1, "global")}, {key = "i4"}), t"\'"}) end, {}, {key = "i3"}), t"}"
	}),
	s({trig = "config_load", descr = "(config_load) \"config_load\"", priority = 0, trigEngine = te("")}, {
		t"{config_load file=\'", i(1, "", {key = "i1"}), t"\'", d(2, function(args) return sn(nil, {t" section=\'", i(1, "", {key = "i3"}), t"\'"}) end, {}, {key = "i2"}), d(3, function(args) return sn(nil, {t" scope=\'", c(1, {i(1, "local"), i(1, "parent"), i(1, "global")}, {key = "i5"}), t"\'"}) end, {}, {key = "i4"}), t"}"
	}),
	s({trig = "include", descr = "(include) \"{include} tags are used for including other templates in the current template. Any variables available in the current template are also available within the included template.\"", priority = 0, trigEngine = te("")}, {
		t"{include file=\'", i(1, "", {key = "i1"}), t"\'", d(2, function(args) return sn(nil, {t" assign=\'", i(1, "", {key = "i3"}), t"\'"}) end, {}, {key = "i2"}), d(3, function(args) return sn(nil, {t" cache_lifetime=", i(1, "", {key = "i5"})}) end, {}, {key = "i4"}), d(4, function(args) return sn(nil, {t" compile_id=\'", i(1, "", {key = "i7"}), t"\'"}) end, {}, {key = "i6"}), d(5, function(args) return sn(nil, {t" cache_id=\'", i(1, "", {key = "i9"}), t"\'"}) end, {}, {key = "i8"}), d(6, function(args) return sn(nil, {t" scope=\'", c(1, {i(1, "parent"), i(1, "root"), i(1, "global")}, {key = "i11"}), t"\'"}) end, {}, {key = "i10"}), i(7, " variables", {key = "i12"}), t"}"
	}),
})
