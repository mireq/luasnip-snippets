...
ls.add_snippets("java", {
	...
	s({trig = "f", descr = "(f) \"field\"", priority = -50, trigEngine = te("b")}, {
		i(1, "private", {key = "i1"}), t" ", i(2, "String", {key = "i2"}), t" ", d(3, function(args, snip) return sn(nil, { i(1, jt({c_py({"java", 4}, "snip.rv = t[2].lower()", python_globals, args, snip, "", am[4])}, "  "), {key = "i3"}) }) end), t";"
	}),
	...
	s({trig = "ca", descr = "(ca) \"catch\"", priority = -50, trigEngine = te("b")}, {
		t"catch (", i(1, "Exception", {key = "i1"}), t" ", i(2, "e", {key = "i2"}), t")", f(function(args, snip) return c_py({"java", 12}, "nl(snip)", python_globals, args, snip, "", am[12]) end, ae(am[12])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "cle", descr = "(cle) \"class extends\"", priority = -50, trigEngine = te("b")}, {
		t"public class ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"java", 13}, "\nsnip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[13]), "r \"untitled\""}, ""), {key = "i1"}) }) end), t" ", t"extends ", i(2, "Parent", {key = "i2"}), t" ", t"implements ", i(3, "Interface", {key = "i3"}), t" ", t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "clc", descr = "(clc) \"class and constructor\"", priority = -50, trigEngine = te("b")}, c(1, {
		{
			t"public class ", f(function(args, snip) return c_py({"java", 14}, "\nsnip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[14]) end, ae(am[14])), t" {", nl(),
			f(function(args, snip) return c_py({"java", 14}, "\nargs = getArgs(t[1])\nif len(args) == 0: snip.rv = \"\"\nfor i in args:\n\tsnip.rv += \"\\n\\tprivate \" + i[0] + \" \" + i[1]+ \";\"\nif len(args) > 0:\n\tsnip.rv += \"\\n\"", python_globals, args, snip, "", am[14]) end, ae(am[14])), nl(),
			t"\tpublic ", f(function(args, snip) return c_py({"java", 14}, "snip.rv = snip.basename or \"unknown\"", python_globals, args, snip, "", am[14]) end, ae(am[14])), t"(", i(1, "", {key = "i1"}), t") {", f(function(args, snip) return c_py({"java", 14}, "\nargs = getArgs(t[1])\nfor i in args:\n\tsnip.rv += \"\\n\\t\\tthis.\" + i[1] + \" = \" + i[1] + \";\"\nif len(args) == 0:\n\tsnip.rv += \"\\n\"", python_globals, args, snip, "", am[14]) end, ae(am[14])), nl(),
			t"\t}", i(2, "", {key = "i2"}), nl(),
			f(function(args, snip) return c_py({"java", 14}, "\nargs = getArgs(t[1])\nif len(args) == 0: snip.rv = \"\"\nfor i in args:\n\tsnip.rv += \"\\n\\tpublic void set\" + camel(i[1]) + \"(\" + i[0] + \" \" + i[1] + \") {\\n\" + \"\\\n\t\\tthis.\" + i[1] + \" = \" + i[1] + \";\\n\\t}\\n\"\n\n\tsnip.rv += \"\\n\\tpublic \" + i[0] + \" get\" + camel(i[1]) + \"() {\\n\\\n\t\\treturn \" + i[1] + \";\\n\\t}\\n\"\n", python_globals, args, snip, "", am[14]) end, ae(am[14])), nl(),
			t"}"
		},
		{
			t"public class ", f(function(args, snip) return c_py({"java", 15}, "\nsnip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[15]) end, ae(am[15])), t" {", nl(),
			f(function(args, snip) return c_py({"java", 15}, "\nargs = getArgs(t[1])\nfor i in args:\n\tsnip.rv += \"\\n\\tprivate \" + i[0] + \" \" + i[1]+ \";\"\nif len(args) > 0:\n\tsnip.rv += \"\\n\"", python_globals, args, snip, "", am[15]) end, ae(am[15])), nl(),
			t"\tpublic ", f(function(args, snip) return c_py({"java", 15}, "snip.rv = snip.basename or \"unknown\"", python_globals, args, snip, "", am[15]) end, ae(am[15])), t"(", i(1, "", {key = "i1"}), t") {", f(function(args, snip) return c_py({"java", 15}, "\nargs = getArgs(t[1])\nfor i in args:\n\tsnip.rv += \"\\n\\t\\tthis.%s = %s;\" % (i[1], i[1])\nif len(args) == 0:\n\tsnip.rv += \"\\n\"", python_globals, args, snip, "", am[15]) end, ae(am[15])), nl(),
			t"\t}", nl(),
			t"}"
		},
		{
			t"public class ", f(function(args, snip) return c_py({"java", 16}, "\nsnip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[16]) end, ae(am[16])), t" {", nl(),
			nl(),
			t"\tpublic ", f(function(args, snip) return c_py({"java", 16}, "snip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[16]) end, ae(am[16])), t"(", i(1, "", {key = "i2"}), t") {", nl(),
			t"\t\t", i(2, "", {key = "i3"}), nl(),
			t"\t}", nl(),
			t"}"
		},
	...
	s({trig = "cl", descr = "(cl) \"class\"", priority = -50, trigEngine = te("b")}, {
		t"public class ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"java", 17}, "\nsnip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[17]), "r \"untitled\""}, ""), {key = "i1"}) }) end), t" {", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "elif", descr = "(elif) \"else if\"", priority = -50, trigEngine = te("")}, {
		t"else if (", i(1, "", {key = "i1"}), t")", f(function(args, snip) return c_py({"java", 21}, "nl(snip)", python_globals, args, snip, "", am[21]) end, ae(am[21])), t"{", nl(),
	...
	s({trig = "el", descr = "(el) \"else\"", priority = -50, trigEngine = te("w")}, {
		t"else", f(function(args, snip) return c_py({"java", 22}, "nl(snip)", python_globals, args, snip, "", am[22]) end, ae(am[22])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), nl(),
		t"}"
	}),
	...
	s({trig = "fore", descr = "(fore) \"for (each)\"", priority = -50, trigEngine = te("b")}, {
		t"for (", i(1, "", {key = "i1"}), t" : ", i(2, "", {key = "i2"}), t")", f(function(args, snip) return c_py({"java", 24}, "nl(snip)", python_globals, args, snip, "", am[24]) end, ae(am[24])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "fori", descr = "(fori) \"for\"", priority = -50, trigEngine = te("b")}, {
		t"for (int ", i(1, "i", {key = "i1"}), t" = 0; ", cp(1), t" < ", i(2, "10", {key = "i2"}), t"; ", cp(1), t"++)", f(function(args, snip) return c_py({"java", 25}, "nl(snip)", python_globals, args, snip, "", am[25]) end, ae(am[25])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "for", descr = "(for) \"for\"", priority = -50, trigEngine = te("b")}, {
		t"for (", i(1, "", {key = "i1"}), t"; ", i(2, "", {key = "i2"}), t"; ", i(3, "", {key = "i3"}), t")", f(function(args, snip) return c_py({"java", 26}, "nl(snip)", python_globals, args, snip, "", am[26]) end, ae(am[26])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "if", descr = "(if) \"if\"", priority = -50, trigEngine = te("b")}, {
		t"if (", i(1, "", {key = "i1"}), t")", f(function(args, snip) return c_py({"java", 27}, "nl(snip)", python_globals, args, snip, "", am[27]) end, ae(am[27])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), f(function(args, snip) return snip.env.LS_SELECT_DEDENT or {} end), nl(),
		t"}"
	}),
	...
	s({trig = "in", descr = "(in) \"interface\"", priority = -50, trigEngine = te("b")}, {
		t"interface ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"java", 30}, "snip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[30])}, ""), {key = "i1"}) }) end), t" ", t"extends ", i(2, "Parent", {key = "i2"}), t" ", t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "cn", descr = "(cn) \"constructor, \\w fields + assigments\"", priority = -50, trigEngine = te("b")}, c(1, {
		{
			t"public ", f(function(args, snip) return c_py({"java", 36}, "snip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[36]) end, ae(am[36])), t"(", i(1, "", {key = "i1"}), t") {", nl(),
			t"\t", i(2, "", {key = "i2"}), nl(),
			t"}"
		},
		{
			t"\t", f(function(args, snip) return c_py({"java", 37}, "\nargs = getArgs(t[1])\nfor i in args:\n\tsnip.rv += \"\\n\\tprivate \" + i[0] + \" \" + i[1]+ \";\"\nif len(args) > 0:\n\tsnip.rv += \"\\n\"", python_globals, args, snip, "", am[37]) end, ae(am[37])), nl(),
			t"public ", f(function(args, snip) return c_py({"java", 37}, "snip.rv = snip.basename or \"unknown\"", python_globals, args, snip, "", am[37]) end, ae(am[37])), t"(", i(1, "", {key = "i1"}), t") {", f(function(args, snip) return c_py({"java", 37}, "\nargs = getArgs(t[1])\nfor i in args:\n\tsnip.rv += \"\\n\\t\\tthis.%s = %s;\" % (i[1], i[1])\nif len(args) == 0:\n\tsnip.rv += \"\\n\"", python_globals, args, snip, "", am[37]) end, ae(am[37])), nl(),
			t"}"
		},
	})),
	...
	s({trig = "main", descr = "(main) \"method (main)\"", priority = -50, trigEngine = te("b")}, {
		t"public static void main(String[] args)", f(function(args, snip) return c_py({"java", 43}, "nl(snip)", python_globals, args, snip, "", am[43]) end, ae(am[43])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "mt", descr = "(mt) \"method throws\"", priority = -50, trigEngine = te("b")}, {
		i(1, "private", {key = "i1"}), t" ", i(2, "void", {key = "i2"}), t" ", i(3, "method", {key = "i3"}), t"(", i(4, "", {key = "i4"}), t") ", t"throws ", i(5, "", {key = "i6"}), t" ", t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "md", descr = "(md) \"Method With javadoc\"", priority = -50, trigEngine = te("b")}, {
		t"/**", nl(),
		t" * ", i(6, "Short Description", {key = "i6"}), f(function(args, snip) return c_py({"java", 47}, "\nfor i in getArgs(t[4]):\n\tsnip.rv += \"\\n\\t * @param \" + i[1] + \" usage...\"", python_globals, args, snip, "", am[47]) end, ae(am[47])), nl(),
		t" *", f(function(args, snip) return c_py({"java", 47}, "\nif \"throws\" in t[5]:\n\tsnip.rv = \"\\n\\t * @throws \" + t[6]\nelse:\n\tsnip.rv = \"\"", python_globals, args, snip, "", am[47]) end, ae(am[47])), f(function(args, snip) return c_py({"java", 47}, "\nif not \"void\" in t[2]:\n\tsnip.rv = \"\\n\\t * @return object\"\nelse:\n\tsnip.rv = \"\"", python_globals, args, snip, "", am[47]) end, ae(am[47])), nl(),
		t" **/", nl(),
		i(1, "public", {key = "i1"}), t" ", i(2, "void", {key = "i2"}), t" ", i(3, "method", {key = "i3"}), t"(", i(4, "", {key = "i4"}), t") ", t"throws ", i(5, "", {key = "i6"}), t" ", t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "get(ter)?", descr = "(get(ter)?) \"getter\"", priority = -50, trigEngine = te("br")}, {
		t"public ", i(1, "String", {key = "i1"}), t" get", i(2, "Name", {key = "i2"}), t"() {", nl(),
		t"\treturn ", f(function(args, snip) return c_py({"java", 48}, "snip.rv = mixedCase(t[2])", python_globals, args, snip, "", am[48]) end, ae(am[48])), t";", nl(),
		t"}"
	}),
	s({trig = "set(ter)?", descr = "(set(ter)?) \"setter\"", priority = -50, trigEngine = te("br")}, {
		t"public void set", i(1, "Name", {key = "i1"}), t"(", i(2, "String", {key = "i2"}), t" ", f(function(args, snip) return c_py({"java", 49}, "snip.rv = mixedCase(t[1])", python_globals, args, snip, "", am[49]) end, ae(am[49])), t") {", nl(),
		t"\tthis.", f(function(args, snip) return c_py({"java", 49}, "snip.rv = mixedCase(t[1])", python_globals, args, snip, "", am[49]) end, ae(am[49])), t" = ", f(function(args, snip) return c_py({"java", 49}, "snip.rv = mixedCase(t[1])", python_globals, args, snip, "", am[49]) end, ae(am[49])), t";", nl(),
		t"}"
	}),
	s({trig = "se?tge?t|ge?tse?t|gs", descr = "(se?tge?t|ge?tse?t|gs) \"setter and getter\"", priority = -50, trigEngine = te("br")}, {
		t"public void set", i(1, "Name", {key = "i1"}), t"(", i(2, "String", {key = "i2"}), t" ", f(function(args, snip) return c_py({"java", 50}, "snip.rv = mixedCase(t[1])", python_globals, args, snip, "", am[50]) end, ae(am[50])), t") {", nl(),
		t"\tthis.", f(function(args, snip) return c_py({"java", 50}, "snip.rv = mixedCase(t[1])", python_globals, args, snip, "", am[50]) end, ae(am[50])), t" = ", f(function(args, snip) return c_py({"java", 50}, "snip.rv = mixedCase(t[1])", python_globals, args, snip, "", am[50]) end, ae(am[50])), t";", nl(),
		t"}", f(function(args, snip) return c_py({"java", 50}, "snip.rv += \"\\n\"", python_globals, args, snip, "", am[50]) end, ae(am[50])), nl(),
		t"public ", cp(2), t" get", cp(1), t"() {", nl(),
		t"\treturn ", f(function(args, snip) return c_py({"java", 50}, "snip.rv = mixedCase(t[1])", python_globals, args, snip, "", am[50]) end, ae(am[50])), t";", nl(),
		t"}"
	}),
	...
	s({trig = "sw", descr = "(sw) \"switch\"", priority = -50, trigEngine = te("b")}, {
		t"switch (", i(1, "", {key = "i1"}), t")", f(function(args, snip) return c_py({"java", 59}, "nl(snip)", python_globals, args, snip, "", am[59]) end, ae(am[59])), t"{", nl(),
	...
	s({trig = "tc", descr = "(tc) \"test case\"", priority = -50, trigEngine = te("")}, {
		t"public class ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_py({"java", 61}, "snip.rv = snip.basename or \"untitled\"", python_globals, args, snip, "", am[61])}, ""), {key = "i1"}) }) end), t" extends ", i(2, "TestCase", {key = "i2"}), f(function(args, snip) return c_py({"java", 61}, "nl(snip)", python_globals, args, snip, "", am[61]) end, ae(am[61])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "t", descr = "(t) \"test\"", priority = -50, trigEngine = te("b")}, {
		f(function(args, snip) return c_py({"java", 62}, "junit(snip)", python_globals, args, snip, "", am[62]) end, ae(am[62])), t"public void test", i(1, "Name", {key = "i1"}), t"() {", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	s({trig = "tt", descr = "(tt) \"test throws\"", priority = -50, trigEngine = te("b")}, {
		f(function(args, snip) return c_py({"java", 63}, "junit(snip)", python_globals, args, snip, "", am[63]) end, ae(am[63])), t"public void test", i(1, "Name", {key = "i1"}), t"() ", i(2, "throws Exception ", {key = "i2"}), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "wh", descr = "(wh) \"while\"", priority = -50, trigEngine = te("b")}, {
		t"while (", i(1, "", {key = "i1"}), t")", f(function(args, snip) return c_py({"java", 65}, "nl(snip)", python_globals, args, snip, "", am[65]) end, ae(am[65])), t"{", nl(),
		t"\t", i(0, "", {key = "i0"}), nl(),
		t"}"
	}),
	...
	s({trig = "@fi", descr = "(@fi)", priority = -1000, trigEngine = te("w")}, {
		t"@file ", d(1, function(args, snip) return sn(nil, { i(1, jt({c_viml("vim_snippets#Filename(\"$1\")")}, ""), {key = "i1"}) }) end), t".java"
	}),
